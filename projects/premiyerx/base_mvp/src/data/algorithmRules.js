...
export const SCORING_RULES = [
  ...
  },
  {
    ...
    evaluate: (text) => {
      ...
      if (/\b(?:told me|walked me|put it|admitted|DM'd me|messaged me|emailed me|shared (?:the|a) (?:post-?mortem|note|memo|finding)|on a (?:call|Friday|recent))\b/i.test(body)) score += 16
