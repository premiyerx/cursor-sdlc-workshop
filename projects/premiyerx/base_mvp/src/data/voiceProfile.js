...
2. SENTENCE RHYTHM: vary length aggressively. Mix short COMPLETE clauses ("She didn't deny it.", "The CFO marked the page.", "Nobody pushed back.") with long, clause-heavy ones. NEVER write standalone one-word exclamations like "Wild.", "Brutal.", "Two things.", "Same.", "Right?", "Truth.", "Facts." — those read as AI tics. NEVER three consecutive sentences of similar length. Every line — including short ones — must be a complete thought or directly extend the line above it. Mobile-first still wins: a short opening line or two + a blank line break is what earns "see more".
...
4. EM-DASHES (complete sentences only): at most two em-dashes total. Every line must be a full sentence or deliberate hook fragment ending in . ! or ? — never cut off mid-phrase (no dangling parentheses, no "was a 47-ticket security" without a verb). Conversational tone is fine; truncated grammar is not.
